// CodeAtlas — hardcoded data for the prototype
...
window.CA_DATA = (function () {
  ...
  // CodeAtlas's own architecture — used as the demo diagram
  const codeAtlasDiagramData = {
    modules: {
      backend: [
        {
          id: "auth-backend",
  ...
  // The single diagram inside the CodeAtlas project
  const diagrams = [
    {
      id: "d_codeatlas_v1",
      ...
      data: codeAtlasDiagramData,
    },
  ];

  return { currentUser, projects, diagrams };
})();
